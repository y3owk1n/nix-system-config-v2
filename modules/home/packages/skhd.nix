...
lib.mkIf pkgs.stdenv.hostPlatform.isDarwin {
  services.skhd = {
    ...
    config = ''
      ...
      # alt - f : @mimi_tile("togglefloat")
      # alt - m : @mimi_tile("togglemax")
      # alt - left : @mimi_tile_sub("stack", "left")
      # alt - right : @mimi_tile_sub("stack", "right")
      # alt - up : @mimi_tile_sub("stack", "up")
      # alt - down : @mimi_tile_sub("stack", "down")
      # alt - 0 : @mimi_tile("unstack")
      # alt - 8 : @mimi_tile("next")
      # alt - 9 : @mimi_tile("prev")
